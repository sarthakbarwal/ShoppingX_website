    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('S', 'Smartphone'), ('L', 'Laptop'), ('E', 'Earphone'), ('TW', 'Top Wear'), ('BW', 'Bottom Wear'), ('AC', 'Accessories')], max_length=2)),
